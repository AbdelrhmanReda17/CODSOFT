...
export const fetchAccessories = (page , sort) => API.get(`/products/accessories/${sort}?page=${page}`);
export const fetchAll = (page , sort) => API.get(`/products/all/${sort}?page=${page}`);

export const getProduct = (id) => API.get(`/products/${id}`);
export const getProductsBySearch = (page,type,text) => API.get(`/products/${type}/search?search=${text}&page=${page}`);
